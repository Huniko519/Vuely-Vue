<template>
    <v-menu offset-y origin="left top" transition="slide-y-transition" content-class="quciklink-dropdown" right
            nudge-top="-10" class="v-step-1 quick-link">
        ...
        <div class="dropdown-content">
            ...
            <v-list class="dropdown-list">
                <v-list-tile v-for="link in links" :key="link.title" :to="getMenuLink(link.to)">
