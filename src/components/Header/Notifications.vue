<template>
    <v-menu offset-y left origin="right top" z-index="100" content-class="notification-dropdown"
            transition="slide-y-transition" nudge-top="-10">
        ...
        <div class="dropdown-content">
            ...
            <v-list class="dropdown-list">
                <v-list-tile v-for="notification in notifications" :key="notification.title" @click="false">
